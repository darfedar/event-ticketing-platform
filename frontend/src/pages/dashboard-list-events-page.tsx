      ...
      <div className="container mx-auto px-4 py-10">
        <div className="mb-8 rounded-[32px] border border-white/10 bg-slate-900/80 p-8 shadow-2xl">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 text-slate-400">Events you have created and manage from this dashboard.</p>
            </div>
        ...
        <div className="space-y-4">
          {events?.content.map((eventItem) => (
            <Card key={eventItem.id} className="bg-slate-900 border border-white/5 text-white transition hover:-translate-y-1 hover:shadow-xl">
              <CardHeader>
